...
@NgModule({
  ...
  declarations: [Tab4Page, CentralComponent, InClckTwComponent, JavaRdComponent, JavaRd2Component, FerryPierComponent, StarFerryComponent, TinHauComponent, WanChaiComponent, ZoneStationComponent, TamarZoneSubstationComponent]
})
